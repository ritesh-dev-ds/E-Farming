...
{
	prid=request.getParameter("uname");
try
{
PreparedStatement ps=con.prepareStatement("select * from farmerdetail where uname=?");
ps.setString(1,prid);
...
<div class="container">
		<div class="row">
			<div class="col-sm-5">
				<form action=selleredit2.jsp method = "post" >
				<div class="form-group">
					...
					<div class="form-group">
						<label for="exampleInputEmail1">Company Name</label> <input type="text" name=txtDisc
							class="form-control" id="txtDisc" aria-describedby="emailHelp" required value="<%= rs.getString(8) %>" >
