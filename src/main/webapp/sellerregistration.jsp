...
function registration()
{
	...
	var comp= document.getElementById("ucom").value;
	...
	if(comp=='')
	{
		...
		document.getElementById("ucom").focus;
		return false;
	}
	if(addr=='')
	{
...
<body>
  ...
  <div class="container">
	...
	<form action=sellerregistration2.jsp method=post>
	<div class="login">
	<table cellspacing="2" align="center" cellpadding="8" border="0">
	<tr>
	<td align="right">Enter Full Name :</td>
	<td><input type="text" placeholder="Enter user here" id="fname" name="fname" class="tb" /></td>
	</tr>
	<tr>
	<td align="right">Enter Email ID :</td>
	<td><input type="text" placeholder="Enter Email ID here" id="uemail" name="uemail" class="tb" /></td>
	</tr>
	<tr>
	<td align="right">Enter Username :</td>
	<td><input type="text" placeholder="Enter Username here" id="uname" name="uname" class="tb" /></td>
	</tr>
	<tr>
	<td align="right">Enter Password :</td>
	<td><input type="password" placeholder="Enter Password here" id="upass" name="upass" class="tb" /></td>
	</tr>
	<tr>
	<td align="right">Enter Confirm Password :</td>
	<td><input type="password" placeholder="Enter Password here" id="ucpass" name="ucpass" class="tb" /></td>
	</tr>
	<tr>
	<td align="right">Enter Moblie No. :</td>
	<td><input type="mobile" placeholder="Enter Mobilr No. here" id="umob" name="umob" class="tb" /></td>
	</tr>
	<tr>
	<td align="right">Enter Date Of Birth :</td>
	<td><input type="date" placeholder="Enter Date Of Birth here" id="udob" name="udob" class="tb" /></td>
	</tr>
	<tr>
	<td align="right">Enter Company Name :</td>
	<td><input type="text" placeholder="Enter Company Name here" id="ucom" name="ucomp" class="tb" /></td>
	</tr>
	<tr>
	<td align="right">Address :</td>
	<td><input type="text" placeholder="Enter Address here" id="uadd" name="uadd" class="tb" /></td>
	</tr>
	<tr>
	<td></td>
	<td>
	<input type="submit" value="Create Account" class="btn" onclick="return registration();" /></td>
	</tr>
	</table>
	</div>
