...
function register1(){
	 ...
	 window.location = "buyerregistration.jsp";
}
</script>
...
<body>
  ...
  <div class="container">
	...
	<div id="main">
	<div class="h-tag">
	<h2 align="center">Welcome To Buyer Login</h2>
	</div>
	<form action=buyerlogin2.jsp method=post>
	<div class="login">
	<table cellspacing="2" align="center" cellpadding="8" border="0">
	<tr>
	<td>Enter User Name :</td>
	<td><input type="text" placeholder="Enter user name here" id="email" name="bname" class="tb" /></td>
	</tr>
	<tr>
	<td>Enter Password :</td>
	<td><input type="password" placeholder="Enter Password here" id="pwd1" name="bpass" class="tb" /></td>
	</tr>
	<tr>
	<td></td>
	<td>
	...
	<tr>
	<td>New User Register here:</td><td><input type="button" value="Click here" onclick="register1()" class="btn" /></td>
	</tr>
	</table>
	</div>
